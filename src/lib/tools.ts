...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    category: 'Finance',
    icon: 'Calculator',
    description: 'Free online bmi calculator with fast, simple results.',
    longDescription: 'Free online bmi calculator with fast, simple results. Get accurate results instantly with an easy-to-use interface from All2ools.',
    features: ['Fast results', 'Easy to use', 'Works on desktop and mobile', 'Free to use'],
    howItWorks: ['Open the tool', 'Enter your values', 'Review the result', 'Adjust inputs as needed'],
    useCases: ['Everyday calculations', 'Planning and comparison', 'Quick estimates'],
