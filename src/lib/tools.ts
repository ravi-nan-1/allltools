...
export const tools: Tool[] = [
  ...
  // ==========================================
  {
    ...
    longDescription: 'Calculate monthly loan EMI, total interest, and repayment cost for loans in the USA, India, and worldwide. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate monthly payments, total interest, and total repayment for personal, auto, home, and other installment loans. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate mortgage payments, total interest, and total home financing cost with optional property tax, insurance, and PMI. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Calculate home loan EMI and repayment costs with principal, interest rate, tenure, and optional extra payments. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Calculate car loan payments, total interest, and total cost using vehicle price, down payment, rate, and loan term. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate personal loan monthly payments, total interest, and repayment amount for flexible loan terms. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate student loan payments, total interest, and payoff cost for education debt. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate how long it can take to pay off credit card debt and how much interest you may pay. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Calculate interest earned or paid using principal, rate, time, and compounding settings. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Calculate simple interest, total interest, and final amount quickly using principal, rate, and time. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Calculate compound growth for savings and investments and see how interest compounds over time. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate investment growth, total contributions, returns, and annualized performance from an initial investment and ongoing contributions. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Calculate return on investment, profit, and ROI percentage for investments, projects, campaigns, and purchases. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  },
  {
    ...
    longDescription: 'Estimate how inflation changes purchasing power and the future value of money over time. Designed for quick estimates with clear results and a responsive interface. Use it for everyday financial planning and compare scenarios before making financial decisions.',
    features: ['Clear input and result breakdown', 'Responsive design for desktop and mobile', 'Useful totals such as interest, cost, or return', 'Scenario-friendly calculations', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested financial inputs', 'Choose the available term, rate, contribution, or compounding options', 'Select Calculate to update the estimate', 'Review the result and compare different scenarios'],
    useCases: ['Consumers comparing borrowing or repayment scenarios', 'Students and families planning education costs', 'Home and car buyers estimating financing', 'Investors evaluating growth and returns', 'Businesses checking project or campaign returns'],
  ...
  // ==========================================
  // EXPANSION: CALCULATORS & EVERYDAY UTILITIES
  // ==========================================
  {
    name: 'Stopwatch',
    slug: 'stopwatch',
    category: 'Business',
    icon: 'Clock3',
    description: 'A precise online stopwatch with start, pause, and reset controls and hundredth-second timing.',
    longDescription: 'Use a browser-based stopwatch for workouts, study sessions, presentations, experiments, cooking, sports drills, and everyday timing.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['online stopwatch', 'stopwatch timer', 'free stopwatch', 'digital stopwatch'],
    metaTitle: 'Stopwatch' + ' - Free Online Calculator | All2ools',
    metaDescription: 'A precise online stopwatch with start, pause, and reset controls and hundredth-second timing.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'Landmark',
    description: 'Estimate retirement savings growth, future portfolio value, contributions, and the effect of time and expected returns.',
    longDescription: 'Plan retirement scenarios by comparing current savings, annual contributions, retirement age, and an assumed investment return.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['retirement calculator', 'retirement savings calculator', 'retirement planning calculator', '401k retirement calculator'],
    metaTitle: 'Retirement Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate retirement savings growth, future portfolio value, contributions, and the effect of time and expected returns.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'BadgeDollarSign',
    description: 'Estimate an illustrative pension from salary, years of service, and a pension accrual rate.',
    longDescription: 'Model a pension scenario with transparent assumptions so you can understand how service and salary can affect an estimated benefit.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['pension calculator', 'pension estimate calculator', 'retirement pension calculator'],
    metaTitle: 'Pension Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate an illustrative pension from salary, years of service, and a pension accrual rate.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'SIP Calculator',
    slug: 'sip-calculator',
    category: 'Finance',
    icon: 'TrendingUp',
    description: 'Estimate SIP investment growth, total contributions, and potential returns from recurring investments.',
    longDescription: 'Calculate the projected value of monthly SIP contributions using an assumed annual return and investment period.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['SIP calculator', 'mutual fund SIP calculator', 'monthly SIP calculator', 'SIP return calculator'],
    metaTitle: 'SIP Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate SIP investment growth, total contributions, and potential returns from recurring investments.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'FD Calculator',
    slug: 'fd-calculator',
    category: 'Finance',
    icon: 'PiggyBank',
    description: 'Estimate fixed deposit maturity value and interest using deposit amount, rate, tenure, and compounding frequency.',
    longDescription: 'Compare fixed-deposit scenarios by changing principal, interest rate, tenure, and compounding frequency.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['FD calculator', 'fixed deposit calculator', 'FD maturity calculator', 'fixed deposit interest calculator'],
    metaTitle: 'FD Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate fixed deposit maturity value and interest using deposit amount, rate, tenure, and compounding frequency.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'PPF Calculator',
    slug: 'ppf-calculator',
    category: 'Finance',
    icon: 'Landmark',
    description: 'Estimate PPF growth from annual contributions, an assumed interest rate, and the investment period.',
    longDescription: 'Use an assumption-based PPF projection to understand contributions, estimated interest, and future value over time.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['PPF calculator', 'PPF maturity calculator', 'PPF interest calculator'],
    metaTitle: 'PPF Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate PPF growth from annual contributions, an assumed interest rate, and the investment period.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'NPS Calculator',
    slug: 'nps-calculator',
    category: 'Finance',
    icon: 'Landmark',
    description: 'Estimate NPS corpus growth, annuity allocation, and the remaining lump-sum portion from recurring contributions.',
    longDescription: 'Explore retirement corpus scenarios by adjusting contributions, expected return, years to retirement, and annuity allocation.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['NPS calculator', 'NPS pension calculator', 'NPS corpus calculator'],
    metaTitle: 'NPS Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate NPS corpus growth, annuity allocation, and the remaining lump-sum portion from recurring contributions.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'BadgeDollarSign',
    description: 'Estimate 401(k) growth from your current balance, employee contributions, employer match, return assumption, and years.',
    longDescription: 'Model a simplified 401(k) projection for US retirement planning and compare the impact of contributions and employer matching.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['401k calculator', '401(k) calculator', '401k retirement calculator', 'employer match calculator'],
    metaTitle: '401(k) Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate 401(k) growth from your current balance, employee contributions, employer match, return assumption, and years.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'Landmark',
    description: 'Estimate future Social Security benefit growth from a current monthly benefit and an assumed annual adjustment.',
    longDescription: 'Create an illustrative benefit projection while keeping the adjustment assumption visible rather than presenting it as an official SSA quote.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['Social Security calculator', 'Social Security benefit calculator', 'retirement benefit calculator'],
    metaTitle: 'Social Security Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate future Social Security benefit growth from a current monthly benefit and an assumed annual adjustment.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'Receipt',
    description: 'Estimate income tax and after-tax income using annual income and an effective tax rate.',
    longDescription: 'Use a simple effective-rate model for planning and compare scenarios without pretending to reproduce every federal, state, or national tax rule.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['income tax calculator', 'tax calculator', 'income tax estimator', 'tax estimate calculator'],
    metaTitle: 'Income Tax Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate income tax and after-tax income using annual income and an effective tax rate.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'WalletCards',
    description: 'Estimate annual and monthly take-home pay after income tax, payroll taxes, retirement contributions, and other deductions.',
    longDescription: 'Model an approximate paycheck outcome from gross pay and transparent deduction assumptions.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['take home pay calculator', 'paycheck calculator', 'net pay calculator', 'salary after tax calculator'],
    metaTitle: 'Take-Home Pay Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate annual and monthly take-home pay after income tax, payroll taxes, retirement contributions, and other deductions.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'WalletCards',
    description: 'Convert a pay amount into annual, monthly, and hourly equivalents using work hours and paid weeks.',
    longDescription: 'Compare compensation formats and translate an hourly or weekly rate into an annual salary estimate.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['salary calculator', 'hourly to salary calculator', 'annual salary calculator', 'pay calculator'],
    metaTitle: 'Salary Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Convert a pay amount into annual, monthly, and hourly equivalents using work hours and paid weeks.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'GST Calculator',
    slug: 'gst-calculator',
    category: 'Finance',
    icon: 'Receipt',
    description: 'Calculate GST amount and the total price from a pre-tax amount and GST rate.',
    longDescription: 'Use the GST calculator for Indian pricing, invoices, retail quotes, and quick tax-inclusive calculations.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['GST calculator', 'GST calculation', 'GST inclusive calculator', 'GST tax calculator India'],
    metaTitle: 'GST Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate GST amount and the total price from a pre-tax amount and GST rate.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'Receipt',
    description: 'Calculate sales tax and total purchase cost from a pre-tax price and sales-tax rate.',
    longDescription: 'Estimate tax-inclusive purchase prices for US sales-tax scenarios using the rate you enter.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['sales tax calculator', 'sales tax calculation', 'tax inclusive price calculator', 'US sales tax calculator'],
    metaTitle: 'Sales Tax Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate sales tax and total purchase cost from a pre-tax price and sales-tax rate.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Percent',
    description: 'Solve common percentage calculations quickly, including a percentage of a number and percentage-to-decimal conversion.',
    longDescription: 'Use percentage calculations for discounts, grades, business metrics, finance, statistics, and everyday comparisons.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['percentage calculator', 'percentage of a number', 'percent calculator', 'percentage change calculator'],
    metaTitle: 'Percentage Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Solve common percentage calculations quickly, including a percentage of a number and percentage-to-decimal conversion.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'Age Calculator',
    slug: 'age-calculator',
    category: 'Business',
    icon: 'CalendarDays',
    description: 'Calculate age from a birth date to a target date and show the elapsed time in years and days.',
    longDescription: 'Find an exact date-based age for forms, planning, milestones, birthdays, eligibility checks, and personal records.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['age calculator', 'calculate age', 'exact age calculator', 'age in years months days'],
    metaTitle: 'Age Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate age from a birth date to a target date and show the elapsed time in years and days.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'CalendarDays',
    description: 'Calculate days between dates and add or subtract a chosen number of days from a start date.',
    longDescription: 'Use date arithmetic for deadlines, project planning, contracts, schedules, travel, and date-based calculations.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['date calculator', 'days between dates', 'date difference calculator', 'add days to date'],
    metaTitle: 'Date Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate days between dates and add or subtract a chosen number of days from a start date.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'BMI Calculator',
    slug: 'bmi-calculator',
    category: 'Health',
    icon: 'HeartPulse',
    description: 'Calculate body mass index from height and weight using a standard BMI formula.',
    longDescription: 'Get a quick BMI estimate for general awareness. BMI is a screening measure and should not be treated as a diagnosis or complete health assessment.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['BMI calculator', 'body mass index calculator', 'BMI calculator kg cm'],
    metaTitle: 'BMI Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate body mass index from height and weight using a standard BMI formula.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Health',
    icon: 'Flame',
    description: 'Estimate basal metabolic rate and daily calorie needs from age, sex, height, weight, and activity level.',
    longDescription: 'Use calorie estimates as a starting point for general planning; individual energy needs vary with health, body composition, activity, and other factors.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['calorie calculator', 'daily calorie calculator', 'TDEE calculator', 'BMR calorie calculator'],
    metaTitle: 'Calorie Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate basal metabolic rate and daily calorie needs from age, sex, height, weight, and activity level.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'House',
    description: 'Calculate estimated monthly principal-and-interest mortgage payments, total payments, and total interest.',
    longDescription: 'Compare mortgage payment scenarios by changing the loan amount, interest rate, and repayment term.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['mortgage payment calculator', 'monthly mortgage calculator', 'mortgage calculator USA'],
    metaTitle: 'Mortgage Payment Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate estimated monthly principal-and-interest mortgage payments, total payments, and total interest.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Finance',
    icon: 'Car',
    description: 'Estimate vehicle loan payments, amount financed, and total interest from vehicle price, down payment, rate, and term.',
    longDescription: 'Compare auto financing scenarios before shopping for a vehicle or evaluating a lender offer.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['auto loan calculator', 'car payment calculator', 'vehicle loan calculator'],
    metaTitle: 'Auto Loan Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Estimate vehicle loan payments, amount financed, and total interest from vehicle price, down payment, rate, and term.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Tag',
    description: 'Calculate discount amount, sale price, and savings from an original price and discount percentage.',
    longDescription: 'Quickly work out sale prices for shopping, promotions, invoices, retail pricing, and business offers.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['discount calculator', 'sale price calculator', 'percentage discount calculator'],
    metaTitle: 'Discount Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate discount amount, sale price, and savings from an original price and discount percentage.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    name: 'Tip Calculator',
    slug: 'tip-calculator',
    category: 'Business',
    icon: 'Utensils',
    description: 'Calculate tip, total bill, and per-person cost for restaurants, services, and shared bills.',
    longDescription: 'Choose a tip percentage and number of people to split a bill without manual arithmetic.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['tip calculator', 'restaurant tip calculator', 'tip split calculator', 'gratuity calculator'],
    metaTitle: 'Tip Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate tip, total bill, and per-person cost for restaurants, services, and shared bills.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    longDescription: 'Use profit margin and markup calculations to evaluate pricing, products, services, and business scenarios.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['profit margin calculator', 'profit calculator', 'markup calculator', 'gross margin calculator'],
    metaTitle: 'Profit Margin Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate profit, profit margin, and markup from cost and selling price.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Scale',
    description: 'Calculate the units and revenue required to cover fixed and variable costs at a given selling price.',
    longDescription: 'Understand the sales volume needed to reach break-even and test how pricing or costs change the threshold.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['break even calculator', 'break even point calculator', 'break even analysis'],
    metaTitle: 'Break-Even Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Calculate the units and revenue required to cover fixed and variable costs at a given selling price.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Globe2',
    description: 'Convert between major currencies using a transparent exchange-rate calculation and reference-rate lookup when available.',
    longDescription: 'Use the converter for travel, budgeting, international pricing, invoices, and quick currency comparisons.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['currency converter', 'USD to INR converter', 'INR to USD converter', 'exchange rate calculator'],
    metaTitle: 'Currency Converter' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Convert between major currencies using a transparent exchange-rate calculation and reference-rate lookup when available.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Globe2',
    description: 'Convert a local date and time between major time zones around the world, including US, Europe, and Asia.',
    longDescription: 'Coordinate meetings, travel, remote teams, launches, interviews, and events across time zones.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['time zone converter', 'timezone converter', 'US time zone converter', 'IST to EST converter'],
    metaTitle: 'Time Zone Converter' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Convert a local date and time between major time zones around the world, including US, Europe, and Asia.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Calculator',
    description: 'Perform arithmetic, trigonometric, logarithmic, root, and power calculations in a responsive browser calculator.',
    longDescription: 'Use scientific functions for school, engineering, technical work, mathematics, and everyday calculations.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['scientific calculator', 'online scientific calculator', 'math calculator'],
    metaTitle: 'Scientific Calculator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Perform arithmetic, trigonometric, logarithmic, root, and power calculations in a responsive browser calculator.' + ' Free, responsive online calculator from All2ools.',
  },
  {
    ...
    category: 'Business',
    icon: 'Shuffle',
    description: 'Generate random integers between a custom minimum and maximum, with support for multiple results.',
    longDescription: 'Generate numbers for games, sampling, testing, classroom activities, raffles, and other non-security use cases.',
    features: ['Responsive design for desktop and mobile', 'Clear inputs with immediate calculations', 'Transparent assumptions and result breakdowns', 'Useful for everyday planning and comparison', 'No account required for basic calculations'],
    howItWorks: ['Enter the requested values and assumptions', 'Review the inputs and adjust them for your scenario', 'Calculate the result instantly in your browser', 'Compare the output with other realistic scenarios'],
    useCases: ['Everyday personal planning', 'Students and professionals checking calculations', 'Businesses comparing practical scenarios', 'Users preparing estimates before making decisions'],
    keywords: ['random number generator', 'random integer generator', 'random number picker'],
    metaTitle: 'Random Number Generator' + ' - Free Online Calculator | All2ools',
    metaDescription: 'Generate random integers between a custom minimum and maximum, with support for multiple results.' + ' Free, responsive online calculator from All2ools.',
  },
