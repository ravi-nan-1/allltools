...
import { convertImageFormat, downloadBlob, formatFileSize } from "@/lib/image-processing";
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Convert images between PNG, JPG, and WEBP formats</p>
      </div>
      ...
      {!preview ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl p-6 space-y-4 border border-border">
            ...
            {file && (
              <div className="text-sm text-muted-foreground pt-2 border-t border-border">
                Original: {file.type.split("/")[1]?.toUpperCase() || "Unknown"} • {formatFileSize(file.size)}
              </div>
            )}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button onClick={handleConvert} disabled={processing} size="lg" type="button">
