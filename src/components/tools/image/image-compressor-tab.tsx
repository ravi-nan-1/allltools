...
import { compressImage, downloadBlob, formatFileSize } from "@/lib/image-processing";
import { useToast } from "@/hooks/use-toast";
import ImageUploader from "./image-uploader";

const ImageCompressorTab = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Reduce file size while maintaining visual quality</p>
      </div>
      ...
      {!preview ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-2xl p-6 space-y-6 border border-border">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">Higher = Better quality, Larger file</span>
              </div>
              <Slider
                value={[quality]}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button onClick={handleCompress} disabled={processing} size="lg" type="button">
