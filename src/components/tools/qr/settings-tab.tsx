  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <Select value={config.size.toString()} onValueChange={(value) => updateSetting("size", parseInt(value))}>
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          className="w-full"
        />
        <p className="text-xs text-muted-foreground">White space around the QR code (recommended: 4)</p>
      </div>
