        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-muted-foreground">{config.logoSize}%</span>
            </div>
            <Slider
              ...
              className="w-full"
            />
            <p className="text-xs text-muted-foreground">Recommended: 15-30% for optimal scanning</p>
          </div>
        </div>
      )}
      ...
      <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg">
        <div className="flex gap-2">
          ...
          <p className="text-xs text-muted-foreground">
            Adding a logo reduces scanning reliability. Use error correction level H for best results.
          </p>
        </div>
      </div>
    </div>
