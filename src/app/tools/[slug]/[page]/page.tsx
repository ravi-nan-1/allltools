...
export default async function ToolSubPage({
  ...
  const pageContentMap: Record<string, PageContent> = {
    ...
    privacy: {
      ...
      content: (
        <div className="space-y-4">
            <p>Your privacy is a top priority when you use the <strong>{tool.name}</strong> tool. We have designed our tools with a &quot;privacy-first&quot; approach to ensure your data remains secure and confidential.tial.</p>
            <p>
      ...
      content: (
        <div className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6">
                <li>
                    <strong>&quot;AS-IS&quot; Provision:sion:</strong> This tool is provided &quot;AS-IS" and &quot;AS-AVAILABLE" without any warranties, express or implied. While we make every effort to ensure the accuracy, reliability, and functionality of our tools, we do not guarantee that the results will be error-free or suitable for every purpose.
                               </li>
                <li>
